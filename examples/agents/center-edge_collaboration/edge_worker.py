...
class CustomModelConfig(HModelConfig):
    name: str = field(default="hepai/edge-agent-demo", metadata={"help": "Model's name"})
...
class CustomWorkerConfig(HWorkerConfig):
    ...
    port: int = field(default=0, metadata={"help": "Worker's port, default is 42600"})
    ...
    _metadata: Dict = field(default_factory=lambda: {"join_topics": ["besiii", 'csns']})  # Example metadata field
