...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, num_classes=1000):
		...
		# self.avgpool = nn.AvgPool2d(14)  # [bs, 2048, 16, 16] to [bs, 2048, 1, 1]
		self.avgpool = nn.AdaptiveAvgPool2d((1, 3))  # [bs, 2048, 12, 40] to [bs, 2048, 1, 3]
	...
	def forward(self, x):
		...
		x = self.layer3(x)
		x = self.layer4(x)
		# print(x.shape)  # [bs, 2048, 16, 16]  16=256/16
		x = self.avgpool(x)
		# print('xx', x.shape)
		# x = x.view(x.size(0), -1)
