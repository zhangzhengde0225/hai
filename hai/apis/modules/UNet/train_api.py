...
# impport module libs
from . import BasicDataset, CarvanaDataset
from . import dice_loss
from . import evaluate
from . import Pytorch_UNet as UNet
...
def train_net(net,
              ...
              amp: bool = False):
    # 1. Create dataset
    dir_img = Path(f'{source}/imgs')
    dir_mask = Path(f'{source}/masks')
    try:
    ...
    for epoch in range(1, epochs+1):
        ...
        if save_checkpoint:
            dir_checkpoint = Path(f'{os.getcwd()}/runs/unet_exp/weights')
